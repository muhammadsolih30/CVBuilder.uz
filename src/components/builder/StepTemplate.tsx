...
function Svg01({ a }: { a: string }) {
  return (
    <svg viewBox="0 0 90 120" xmlns="http://www.w3.org/2000/svg" width="100%" height="100%">
...
function Svg03({ a }: { a: string }) {
  return (
    <svg viewBox="0 0 90 120" xmlns="http://www.w3.org/2000/svg" width="100%" height="100%">
      ...
      <rect x="8" y="15" width="30" height="2.5" fill="rgba(255,255,255,0.6)" rx="1"/>
      <rect x="8" y="32" width="20" height="2" fill={a} rx="1"/>
      <line x1="8" y1="36" x2="82" y2="36" stroke={a} strokeWidth="0.8" opacity="0.4"/>
...
function Svg05({ a }: { a: string }) {
  return (
    <svg viewBox="0 0 90 120" xmlns="http://www.w3.org/2000/svg" width="100%" height="100%">
      ...
      <rect x="34" y="16" width="28" height="2.5" fill="rgba(255,255,255,0.7)" rx="1"/>
...
function Svg09({ a }: { a: string }) {
  return (
    <svg viewBox="0 0 90 120" xmlns="http://www.w3.org/2000/svg" width="100%" height="100%">
      ...
      <rect x="8" y="29" width="35" height="2.5" fill={a} rx="1" opacity="0.7"/>
...
function Svg12({ a }: { a: string }) {
  return (
    <svg viewBox="0 0 90 120" xmlns="http://www.w3.org/2000/svg" width="100%" height="100%">
      ...
      <rect x="4" y="8" width="24" height="24" fill="rgba(255,255,255,0.1)" rx="12"/>
...
function Svg16({ a }: { a: string }) {
  return (
    <svg viewBox="0 0 90 120" xmlns="http://www.w3.org/2000/svg" width="100%" height="100%">
      ...
      <rect x="14" y="21" width="55" height="2" fill="rgba(255,255,255,0.5)" rx="1"/>
...
function Svg18({ a }: { a: string }) {
  return (
    <svg viewBox="0 0 90 120" xmlns="http://www.w3.org/2000/svg" width="100%" height="100%">
      ...
      <rect x="14" y="20" width="28" height="2" fill="rgba(254,243,199,0.6)" rx="1"/>
...
function Svg19({ a }: { a: string }) {
  return (
    <svg viewBox="0 0 90 120" xmlns="http://www.w3.org/2000/svg" width="100%" height="100%">
      <rect width="90" height="120" fill="#fff" rx="2"/>
      <circle cx="45" cy="18" r="13" fill="#f1f5f9" stroke={a} strokeWidth="1.5"/>
...
function Svg20({ a }: { a: string }) {
  return (
    <svg viewBox="0 0 90 120" xmlns="http://www.w3.org/2000/svg" width="100%" height="100%">
      <defs>
        <linearGradient id={`g20${a.replace('#','')}`} x1="0" y1="0" x2="1" y2="0">
          <stop offset="0%" stopColor={a}/>
          <stop offset="100%" stopColor="#ec4899"/>
        </linearGradient>
      </defs>
      <rect width="90" height="120" fill="#fff" rx="2"/>
      <rect x="8" y="8" width="74" height="22" fill={`url(#g20${a.replace('#','')})`} rx="2"/>
...
function DynSvg({ pal, a }: { pal: typeof DYN_PALETTES[0]; a: string }) {
  ...
  if (sty === "full-header") return (
    <svg viewBox="0 0 90 120" xmlns="http://www.w3.org/2000/svg" width="100%" height="100%">
      <rect width="90" height="120" fill={bg} rx="2"/>
      <rect x="8" y="8" width="74" height="22" fill={hdr} rx="2"/>
      <rect x="14" y="13" width="40" height="5" fill={bg} rx="1" opacity="0.9"/>
      <rect x="14" y="21" width="55" height="2" fill={a} rx="1" opacity="0.5"/>
      <rect x="8" y="36" width="18" height="2" fill={a} rx="1"/>
  ...
  if (sty === "top-bar") return (
    <svg viewBox="0 0 90 120" xmlns="http://www.w3.org/2000/svg" width="100%" height="100%">
      <rect width="90" height="120" fill={bg} rx="2"/>
      <rect x="8" y="8" width="74" height="3" fill={a}/>
      <rect x="8" y="14" width="50" height="7" fill={hdr} rx="1"/>
      <rect x="8" y="24" width="35" height="2.5" fill={a} rx="1" opacity="0.7"/>
  ...
  if (sty === "corner") return (
    <svg viewBox="0 0 90 120" xmlns="http://www.w3.org/2000/svg" width="100%" height="100%">
      ...
      <rect x="8" y="19" width="28" height="2.5" fill={a} rx="1" opacity="0.7"/>
...
const STATIC_SVGS = [Svg01,Svg02,Svg03,Svg04,Svg05,Svg06,Svg07,Svg08,Svg09,Svg10,
  Svg11,Svg12,Svg13,Svg14,Svg15,Svg16,Svg17,Svg18,Svg19,Svg20,Svg21,Svg22,Svg23,Svg24,Svg25];
...
const STATIC_NAMES: [string, string][] = [
  ["Clean Line","Toza chiziq"],["Dark Accent","Qora aksent"],["Classic Top","Klassik sarlavha"],
  ["Modern Panel","Yon panelli"],["Teal Photo","Foto bilan"],["Blue Box","Ko'k quti"],
  ["Bold Stripe","Qalin chiziq"],["Cyber Dark","Kiber qora"],["Double Bar","Qo'sh chiziq"],
  ["Forest Pro","O'rmon yashil"],["Red Dual","Qizil juft"],["Navy Side","Dengiz panel"],
  ["Purple Soft","Yumshoq binafsha"],["Corner Fold","Burchak burama"],["Gold Dark","Oltin-qora"],
  ["Sky Banner","Osmon banneri"],["Prism Dark","Prizma qora"],["Amber Warm","Iliq qahrabo"],
  ["Centered","Markaziy foto"],["Gradient","Gradient"],["Cyan Lines","Moviy chiziqlar"],
  ["Cyber Navy","Kiber dengiz"],["Split View","Bo'lingan ko'rinish"],["Green Block","Yashil blok"],
  ["Mocha Dark","Qahva qora"],
];
const DYN_ADJ = ["Elegant","Bold","Clean","Sharp","Sleek","Refined","Crisp","Vivid","Polished","Precise",
  "Smooth","Bright","Rich","Calm","Dynamic","Soft","Strong","Deep","Warm","Cool","Fresh","Pure","Clear","Fine"];
const DYN_DESC = ["Professional","Modern","Classic","Elegant","Bold","Creative","Minimal","Stylish","Dynamic","Clean",
  "Refined","Sharp","Balanced","Strong","Fluid","Precise","Vivid","Sleek","Calm","Rich","Fresh","Clear","Warm","Crisp"];
...
// PREVIEW DIALOG
// ─────────────────────────────────────────────────
function PreviewModal({ tKey, name, desc, accent, onSelect }: {
  tKey: string; name: string; desc: string; accent: string; onSelect: () => void;
}) {
        ...
        >
          ...
          >
            ...
            <div className="flex justify-center p-3 bg-gray-50 rounded-xl mb-4">
              <div style={{width:200, height:267}} className="rounded-lg overflow-hidden shadow-lg border border-gray-200">
    ...
    <div className="max-w-4xl mx-auto space-y-5">
      ...
      <div>
        ...
        <p className="text-muted-foreground text-sm">
          Rangni va shriftni tanlang, keyin <span className="font-semibold text-foreground">100 ta</span> shablon ichidan birini tanlang
        </p>
      </div>
      ...
      <div className="rounded-2xl border border-border bg-card p-4">
          ...
          {COLORS.map((c) => (
            <button
              ...
              style={{
                ...
                boxShadow: safeColor === c.key ? `0 0 0 2.5px #fff, 0 0 0 4.5px ${c.hex}` : undefined,
        ...
        <div className="grid grid-cols-12 gap-1.5 mt-1">
          {COLORS.map((c) => (
            <p key={c.key} className="text-[8px] text-center text-muted-foreground truncate leading-tight">
              {c.label}
            </p>
          ))}
        </div>
          ...
          {FONTS.map((f) => (
            <button
              ...
              style={{
                ...
                backgroundColor: safeFont === f.key ? accentHex + "12" : undefined,
              }}
            >
              <p className="text-xl font-bold text-center" style={{ color: accentHex }}>Aa</p>
              <p className="text-xs text-center text-muted-foreground mt-0.5">{f.label}</p>
            </button>
          ))}
        </div>
      </div>
                  ...
                  <button
                    ...
                    style={{
                      border: isSelected
                        ? `2px solid ${accentHex}`
                        : "2px solid #e5e7eb",
                      boxShadow: isSelected ? `0 0 0 1px ${accentHex}30` : undefined,
                    }}
                  >
                    {/* Preview rasm */}
                    <div
      ...
      <div
        ...
        style={{ borderColor: accentHex + "50", backgroundColor: accentHex + "08" }}
      >
        <div className="rounded-xl overflow-hidden border border-gray-200 shadow-sm flex-shrink-0" style={{width:52,height:70}}>
          <TemplatePreview tKey={safeTemplate} accent={accentHex}/>
        </div>
        <div className="flex-1 min-w-0">
          <p className="text-sm font-bold truncate flex items-center gap-1.5">
            <Check className="w-3.5 h-3.5 flex-shrink-0" style={{ color: accentHex }}/>
            {ALL_TEMPLATES.find((t) => t.key === safeTemplate)?.name || safeTemplate}
          </p>
          <p className="text-xs text-muted-foreground mt-0.5">
            {COLORS.find((c) => c.key === safeColor)?.label} rang · {safeFont} shrift
          </p>
        </div>
        <div
