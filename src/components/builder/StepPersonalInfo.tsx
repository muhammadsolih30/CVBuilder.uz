...
import { User, Phone, Mail, MapPin, Linkedin, Send, X } from "lucide-react";
...
export default function StepPersonalInfo({ data, onChange }: Props) {
  const handlePhotoUpload = (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    // BUG FIX: fayl hajmini tekshirish (5MB limit)
  ...
  return (
    <div className="max-w-2xl mx-auto space-y-6">
      ...
      <div className="flex items-center gap-4">
        {/* BUG FIX: rasm o'chirish tugmasi qo'shildi */}
      ...
      <div className="grid sm:grid-cols-2 gap-4">
        {fields.map((f) => (
          <div
            key={f.key}
            className={f.key === "fullName" ? "sm:col-span-2" : ""}
          >
